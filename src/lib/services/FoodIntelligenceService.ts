...
// Authentic Indian Food Composition Tables (IFCT) & Global Food mock-db
const IFCT_DATABASE: Record<string, Partial<FoodNutrition>> = {
  ...
  'grilled chicken breast': {
    ...
    isVegan: false,
    isGlutenFree: true,
    benefits: ['Excellent source of lean protein', 'Supports muscle repair and growth'],
    risks: [],
  ...
  'salad': {
    ...
    isVegan: true,
    isGlutenFree: true,
    benefits: ['High in vitamins and dietary fiber', 'Low calorie density'],
    risks: [],
    apiSource: 'USDA FoodData Central',
    confidence: 100
  },
  'apple': {
    ...
    isVegan: true,
    isGlutenFree: true,
    benefits: ['Good source of vitamin C and fiber', 'Supports heart health'],
    risks: [],
    apiSource: 'USDA FoodData Central',
    confidence: 100
  },
  'boiled egg': {
    ...
    isVegan: false,
    isGlutenFree: true,
    benefits: ['High quality complete protein', 'Rich in choline and Vitamin D'],
    risks: [],
    apiSource: 'USDA FoodData Central',
    confidence: 100
  },
  'coca cola': {
    ...
    isGlutenFree: true,
    benefits: [],
    risks: ['High in added sugars', 'Promotes tooth decay', 'Elevated glycemic load'],
  ...
  'protein bar': {
    ...
    isVegan: false,
    isGlutenFree: true,
    benefits: ['High protein density', 'Good source of calcium and fiber'],
    risks: [],
    apiSource: 'OpenFoodFacts Database',
    confidence: 100
  }
    ...
    if (cachedFood && cachedFood.cachedAt) {
      ...
      if (ageHours < 24) {
        ...
        return {
          ...
          vitaminC: cachedFood.vitaminC || 0,
          vitaminD: cachedFood.vitaminD || 0,
