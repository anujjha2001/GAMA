...
import { Search, Sparkles, HeartPulse, Workflow, BarChart3, Settings, Moon, Sun } from 'lucide-react';
...
export function CommandPalette({ isOpen, onClose, onNavigate }: CommandPaletteProps) {
  ...
  const commands = [
    ...
    { id: 'theme-dark', label: 'Switch to Dark Theme', category: 'Preferences', icon: Moon, action: () => setTheme('dark') },
    { id: 'theme-light', label: 'Switch to Light Theme', category: 'Preferences', icon: Sun, action: () => setTheme('light') },
  ];
