          ...
          >
            {MODELS.map(model => (
              <button
                ...
                className={`w-full text-left px-3 py-2 rounded-xl text-xs flex flex-col gap-0.5 transition-colors ${selectedModel.id === model.id ? 'bg-white/5 text-white' : 'hover:bg-white/5 text-neutral-300'
                  }`}
              >
