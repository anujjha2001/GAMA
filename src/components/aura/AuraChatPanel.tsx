...
export function AuraChatPanel({ 
  ...
  // 3. Freeze body scroll when open
  React.useEffect(() => {
    if (isOpen) {
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 w-screen h-screen z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 md:p-8 overflow-hidden select-none"
          onDragOver={handleDragOver}
          onDrop={handleDrop}
        >
          {/* Main Fullscreen Workspace Card */}
          <motion.div
          ...
          >
            ...
            {isLiveCameraActive && (
              <div className="w-[380px] border-r border-white/10 flex flex-col bg-black/40 relative shrink-0">
                ...
                <div className="flex-1 relative flex items-center justify-center p-4">
                  <video 
                    ref={videoRef}
                    className="w-full h-auto aspect-video rounded-2xl bg-neutral-900 border border-white/10 object-cover"
                    muted
                    playsInline
                  />
                ...
                <div className="p-4 border-t border-white/5 text-[11px] text-neutral-400 leading-normal bg-black/20">
            ...
            <div className="flex-1 flex flex-col min-w-0 bg-neutral-950/20">
              ...
              <div className="flex justify-between items-center border-b border-white/5 px-6 py-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    title="Toggle Live Camera Vision Mode"
              ...
              {/* Messages Container */}
              <div className="flex-1 overflow-y-auto space-y-4 px-6 py-6 scrollbar-thin">
                {messages.length === 0 ? (
